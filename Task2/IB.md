...
| 1   | Используется ли многофакторная аутентификация (MFA) для доступа к критическим системам и сервисам?                                       | Да      | У Active Directory есть надстройки для использования MFA             |
...
| 8   | Используются ли системы аутентификации пользователей для доступа к системам?                                                             | Да      | Выделены отдельные контуры для клиентов, собственников, бухгалтерии             |
...
| 12  | Используются ли средства управления учётными записями на базе единого реестра?                                                          | Да      | Active Directory             |
...
| 5   | Выполняется ли регулярное тестирование процесса восстановления данных из резервных копий?                                               | Да      | Выполняет DepOps команда             |
